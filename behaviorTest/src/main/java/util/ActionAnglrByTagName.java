 ...
 * This class is to perform action for Angular Application using tag name
 * input to method will be mainly your webdriver instance, tagname and time out in secs which will check for different pageload strategies (explicit wait,pageload and angular page ready state)
 */
public class ActionAnglrByTagName {
