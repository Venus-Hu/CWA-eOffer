...
public class IntegrationFeatureRunner extends ParentRunner<ParentRunner> {
    ...
    private List<String> requiredScenarios;

    public IntegrationFeatureRunner(CucumberFeature cucumberFeature, Runtime runtime, JUnitReporter jUnitReporter, JsonObject data,
    		List<String> requiredScenarios) throws InitializationError {
        super(null);
        ...
        for (CucumberTagStatement cucumberTagStatement : cucumberFeature.getFeatureElements()) {	
            try {
                ...
                if (cucumberTagStatement instanceof CucumberScenario) {
                	...
                	String scenarioBame = cucumberTagStatement.getVisualName().replace("Scenario:", "").trim();
                	if(!this.requiredScenarios.contains(scenarioBame)) {
                		continue;
                	}
